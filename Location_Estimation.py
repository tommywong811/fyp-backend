...
# Sample Calling Script =>  python Location_Estimation.py -qd ./Query/Test/1504-b.png -td ./dataset/training_set/ -lm ./model/model_newest.h5 -m 10 -m ode h -kd ./keypoints_database.p
